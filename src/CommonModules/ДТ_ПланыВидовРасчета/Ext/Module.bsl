...
Процедура ОткрытьФормуСуществующегоОбъекта(Параметры) Экспорт 
    ...
    ПараметрыОтбора = ДТС_Настройки.ПараметрыОтбораПланаВидовРасчета(Параметры);
...
Процедура ИсполняемыеСценарии() Экспорт 
    ...
    МетаданныеПланыВидовРасчета = ДТС_МетаданныеСервер.МетаданныеПлановВидовРасчета();
    
    Для Каждого ОписаниеМетаданных Из МетаданныеПланыВидовРасчета Цикл
        Если ДТС_Настройки.Пропустить(ОписаниеМетаданных.Идентификатор) Тогда
            Продолжить;
        КонецЕсли;
        
        НаборТестов = ДТС_НаборыТестов.НаборТестовПланаВидовРасчета(ОписаниеМетаданных);
