...
Процедура ИсполняемыеСценарии() Экспорт 
    ...
    МетаданныеРегистрыБухгалтерии = ДТС_МетаданныеСервер.МетаданныеРегистровБухгалтерии();
    
    Для Каждого ОписаниеМетаданных Из МетаданныеРегистрыБухгалтерии Цикл
        Если ДТС_Настройки.Пропустить(ОписаниеМетаданных.Идентификатор) Тогда
            Продолжить;
        КонецЕсли;
        
        НаборТестов = ДТС_НаборыТестов.НаборТестовРегистраБухгалтерии(ОписаниеМетаданных);
